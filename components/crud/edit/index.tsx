...
export default function EditMember({member}:{member:Membro|null}){
    ...
    return(
        <div className="bg-zinc-100 flex items-start justify-center min-h-screen">
            <div className="bg-white w-4/5 flex-col rounded-lg items-center mt-6 h-5/6 justify-center mb-6">
                ...
                <div className=" flex flex-col-reverse items-center justify-around md:flex-row-reverse ">
                    <div className="md:mb-12">
                        <h1 className="text-blue-900 font-semibold text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl 3xl:text-7xl mb-8">EDITAR MEMBRO</h1>
