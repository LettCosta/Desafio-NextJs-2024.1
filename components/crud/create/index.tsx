import { createMember } from "@/back/admin/actions";
            ...
            <div className="md:mb-6">
                ...
                <form className="flex flex-col gap-4" autoComplete="off" action={createMember}>
                    <div className="flex flex-col gap-2 items-center">
                        ...
                        <input name="name" placeholder="Nome" className=" rounded-3xl h-7 mb-6 lg:w-64 lg:mb-8 px-2" />
                        <label className="text-white font-medium text-md md:text-xl lg:text-3xl xl:text-4xl 2xl:text-5xl 3xl:text-6xl">Cargo</label>
                        <input name="cargo" placeholder="Cargo" className=" rounded-3xl h-7 mb-6 lg:w-64 lg:mb-8 px-2"/>
                        <label className="text-white font-medium text-md md:text-xl lg:text-3xl xl:text-4xl 2xl:text-5xl 3xl:text-6xl">Email</label>
                        <input name="email" placeholder="Email" className=" rounded-3xl h-7 mb-6 lg:w-64 lg:mb-8 px-2"/>
                    </div>
