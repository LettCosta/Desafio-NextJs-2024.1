...
export default function Card( {title, price} : CardProps ){
    return(
        <div className="flex flex-col justify-center w-3/4 md:w-1/3 items-center mb-16 hover:shadow-md rounded-lg border border-blue-950 md:border-transparent hover:border-blue-950">
