...
export default function Card( {title, price, text} : CardProps ){
    return(
        <div className="flex flex-col  justify-center w-1/4 items-center mb-16 hover:shadow-lg ">
            ...
            <div style={{backgroundColor: '#D9D9D9'}}  className="bg-white h-64 w-full rounded-sm ">
                <p className="text-black m-4 font-extrabold text-4xl lg:text-3xl md:text-2xl sm:text-lg xl:text-5xl 2xl:text-6xl 3xl:text-7xl text-center">{price}</p>
